...
const fields: Array<{ key: Exclude<keyof SiteContent, "services">; label: string; multiline?: boolean }> = [
  ...
  { key: "tmjAnswer", label: "TMJ answer", multiline: true }, { key: "schrothAnswer", label: "Schroth answer", multiline: true }, { key: "firstVisitAnswer", label: "First visit answer", multiline: true },
