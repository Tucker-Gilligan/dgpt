...
const fields: Array<{ key: Exclude<keyof SiteContent, "services">; label: string; multiline?: boolean }> = [
  ...
  { key: "schrothAnswer", label: "Schroth answer", multiline: true }, { key: "schrothBring", label: "Schroth — what to bring", multiline: true }, { key: "schrothWear", label: "Schroth — what to wear", multiline: true }, { key: "schrothExpect", label: "Schroth — what to expect", multiline: true }, { key: "firstVisitAnswer", label: "First visit answer", multiline: true },
